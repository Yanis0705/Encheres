...
<style><%@include file="/style/Modifier.css"%></style>
...
<form class="boutonsEnregistreSupprimerrAnnuler" action="modifierutilisateur">
	<button type="submit" class="btn-enregistrer" >Enregistrer</button>
	</form>
	<form class="boutonsEnregistreSupprimerrAnnuler" action="supprimerutilisateur"> 
	<button type="submit" class="btn-supprimer">Supprimer mon compte</button>	
</form>
<form class="boutonsEnregistreSupprimerrAnnuler" action="connexionutilisateur">
